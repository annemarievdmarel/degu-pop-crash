...
description <- c("definitely pregnant", "definitely lactating", "definitely postlactating",
                 "both pregnant and/or (post)lactating", "either breeding status with question marks or unknown abbreviation",
...
str(markrecap_30daywindow)

trap <- markrecap_30daywindow %>%
  dplyr::select(orderkey,window, seasonid, season,  year, date, julian_date, 
...
# Environmental data
potentially add avg group size to temporal file
